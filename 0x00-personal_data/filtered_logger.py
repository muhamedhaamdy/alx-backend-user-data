...
def get_db() -> mysql.connector.connection.MySQLConnection:
    ...
    username = os.getenv('PERSONAL_DATA_DB_USERNAME') if os.getenv(
        'PERSONAL_DATA_DB_USERNAME') else 'root'
    password = os.getenv('PERSONAL_DATA_DB_PASSWORD') if os.getenv(
        'PERSONAL_DATA_DB_PASSWORD') else ''
    host = os.getenv('PERSONAL_DATA_DB_HOST') if os.getenv(
